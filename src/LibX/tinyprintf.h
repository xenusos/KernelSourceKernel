...
size_t tfp_vsnprintf(char *str, size_t size, const char *fmt, va_list ap);
size_t tfp_snprintf(char *str, size_t size, const char *fmt, ...);
size_t tfp_vsprintf(char *str, const char *fmt, va_list ap);
size_t tfp_sprintf(char *str, const char *fmt, ...);
